...
var Toast = function (_Component) {
    ...
    (0, _createClass3.default)(Toast, [{
        ...
        value: function render() {
            ...
            var cls = (0, _classnames2.default)('qtui-toast', (0, _defineProperty3.default)({}, className, className));
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_index4.default, { value: icon, size: iconSize, className: 'qtui-icon_toast' }),
                    _react2.default.createElement(
                        'p',
                        { className: 'qtui-toast_content' },
                        children
                    )
                )
            );
