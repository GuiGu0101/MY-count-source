...
var Dialog = function (_Component) {
    ...
    (0, _createClass3.default)(Dialog, [{
        ...
        value: function renderButtons() {
            return this.props.buttons.map(function (action, idx) {
                ...
                var className = (0, _classnames2.default)({
                    'qtui-dialog__btn': true,
                    'qtui-dialog__btn_default': type === 'default',
                    'qtui-dialog__btn_primary': type === 'primary'
                });
        ...
        value: function render() {
            ...
            var cls = (0, _classnames2.default)('qtui-dialog', (0, _defineProperty3.default)({
                'qtui-skin_android': styleType === 'android' || !type && autoDectect && this.state.isAndroid
            }, className, className));
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    title ? _react2.default.createElement(
                        'div',
                        { className: 'qtui-dialog__hd' },
                        _react2.default.createElement(
                            'strong',
                            { className: 'qtui-dialog__title' },
                            title
                        )
                    ) : false,
                    _react2.default.createElement(
                        'div',
                        { className: 'qtui-dialog__bd' },
                        children
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'qtui-dialog__ft' },
                        this.renderButtons()
                    )
                )
            );
...
Dialog.propTypes = {
     ...
     *
     */
    autoDectect: _propTypes2.default.bool,
    /**
