...
var Slider = function (_Component) {
    ...
    (0, _createClass3.default)(Slider, [{
        ...
        value: function render() {
            ...
            var cls = (0, _classnames2.default)('qtui-slider-box', className);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    (0, _extends3.default)({ className: 'qtui-slider' }, domProps),
                    _react2.default.createElement(
                        'div',
                        { className: 'qtui-slider__inner', ref: 'bar' },
                        _react2.default.createElement('div', {
                            style: trackStyles,
                            className: 'qtui-slider__track' }),
                        _react2.default.createElement('div', {
                            style: handlerStyles,
                            onTouchStart: this.handleTouchStart,
                            onTouchMove: this.handleTouchMove,
                            onTouchEnd: this.handleTouchEnd,
                            className: 'qtui-slider__handler' })
                    )
                ),
                showValue ? _react2.default.createElement(
                    'div',
                    { className: 'qtui-slider-box__value' },
                    this.state.value
                ) : false
            );
        }
