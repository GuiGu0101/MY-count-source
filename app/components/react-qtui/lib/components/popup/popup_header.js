...
var PopupHeader = function PopupHeader(props) {
  ...
  var cls = (0, _classnames2.default)('qtui-popup__hd', className);
  return _react2.default.createElement(
    'div',
    { className: cls },
    _react2.default.createElement(
      'a',
      { className: 'qtui-popup__action', onClick: leftOnClick },
      left
    ),
    _react2.default.createElement(
      'a',
      { className: 'qtui-popup__action', onClick: rightOnClick },
      right
    )
  );
};
