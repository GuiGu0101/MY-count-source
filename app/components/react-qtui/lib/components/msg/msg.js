...
var Msg = function (_Component) {
    ...
    (0, _createClass3.default)(Msg, [{
        ...
        value: function render() {
            ...
            var cls = (0, _classnames2.default)('qtui-msg', (0, _defineProperty3.default)({}, className, className));
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'qtui-msg__icon-area' },
                    _react2.default.createElement(_index3.default, { value: type, size: 'large' })
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'qtui-msg__text-area' },
                    _react2.default.createElement(
                        'h2',
                        { className: 'qtui-msg__title' },
                        title
                    ),
                    _react2.default.createElement(
                        'p',
                        { className: 'qtui-msg__desc' },
                        description
                    )
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'qtui-msg__opr-area' },
                    _react2.default.createElement(
                        _index.ButtonArea,
                        null,
                        this._renderButtons()
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'qtui-msg__extra-area' },
                    elFooter()
                )
            );
        }
