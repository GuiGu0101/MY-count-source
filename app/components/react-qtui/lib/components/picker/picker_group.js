...
var PickerGroup = function (_Component) {
    ...
    (0, _createClass3.default)(PickerGroup, [{
        ...
        value: function render() {
            ...
            var cls = (0, _classnames2.default)('qtui-picker__group', className);
            var styles = {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('div', { className: 'qtui-picker__mask' }),
                _react2.default.createElement('div', { className: 'qtui-picker__indicator' }),
                _react2.default.createElement(
                    'div',
                    { className: 'qtui-picker__content',
                        style: styles,
                        ref: 'content' },
                    items.map(function (item, j) {
                        var label = item[_this5.props.mapKeys.label];
                        var itemCls = (0, _classnames2.default)('qtui-picker__item', {
                            'qtui-picker__item_disabled': item.disabled
                        });
