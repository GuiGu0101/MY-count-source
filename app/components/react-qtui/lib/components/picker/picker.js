...
var Picker = function (_Component) {
    ...
    (0, _createClass3.default)(Picker, [{
        ...
        value: function renderActions() {
            var elActions = this.state.actions.map(function (action, i) {
                ...
                return _react2.default.createElement(
                    'a',
                    (0, _extends3.default)({}, others, { key: i, className: 'qtui-picker__action' }),
                    ' ',
                    label
                );
            });
        ...
        value: function render() {
            ...
            var cls = (0, _classnames2.default)('qtui-picker', {
                'qtui-animate-slide-up': show && !this.state.closing,
                'qtui-animate-slide-down': this.state.closing
            }, className);

            var maskCls = (0, _classnames2.default)({
                'qtui-animate-fade-in': show && !this.state.closing,
                'qtui-animate-fade-out': this.state.closing
            });
