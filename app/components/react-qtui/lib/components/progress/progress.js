...
var Progress = function Progress(props) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            { className: 'qtui-progress__bar' },
            _react2.default.createElement('div', { className: 'qtui-progress__inner-bar', style: { width: pgWdith + '%' } })
        ),
        showCancel ? _react2.default.createElement(
            'a',
            { href: 'javascript:;', className: 'qtui-progress__opr', onClick: function onClick(e) {
