!function (bWindow, qtjs) {
    if ('function' == typeof define && (define.amd || define.cmd)) {
        define('static/lib/qt_jssdk', function () {
            return qtjs(bWindow);
        });
    } else {
        qtjs(bWindow, true);
    }
}(this, function (bWindow, qtjs) {
    var initQingtuiJSBridge = function () {
        ...
        if (typeof bWindow.QingtuiJSBridge != 'undefined') {
            ...
            QingtuiJSBridge = bWindow.webkit.messageHandlers.QingtuiJSBridge;
            if (typeof QingtuiJSBridge.invoke == 'undefined') {
                QingtuiJSBridge._list = {};
                QingtuiJSBridge.invoke = function (n, p, f) {
                    var t = Math.random().toString(36).replace('0.', 'qt');
    ...
    var sdkNameToApiName, apiNameToSdkName, documentRoot, docTitle, ua, platform, notMobile, isDebugger, isQTClient,
    ...
    if (!bWindow.jQingTui) {
        sdkNameToApiName = {
            ...
            closeAuthWebView: 'closeAuthWebView',
            uploadTeamAuthImage: 'uploadTeamAuthImage',
            downloadTeamAuthImage: 'downloadTeamAuthImage',
        ...
        isIos = -1 != ua.indexOf('iphone') || -1 != ua.indexOf('ipad') || platform.match('iphone');
        ...
        H = {
            config: function (config) {
                ...
                var isCheck = QTconfig.check === !1 ? !1 : !0;
                isReady(function () {
                    var a, d, e;
                    if (isCheck) {
                        C.preVerifyStartTime = getNowTimestamp();
                        runInvoke(sdkNameToApiName.config, {
            ...
            // ready: function(a) {
            //     0 != G.state ? a() : (F._completes.push(a), !w && QTconfig.debug && a())
            // },
            // error: function(a) {
            ...
            // 关闭webview界面，并且更新认证状态
            closeAuthWebView: function(a) {
                runInvoke(sdkNameToApiName.closeAuthWebView, {}, a);
            },
            // 上传图片
            uploadTeamAuthImage: function (a) {
                runInvoke(sdkNameToApiName.uploadTeamAuthImage, {
                    localIds: a.localIds
                    // isShowProgressTips: 0 == a.isShowProgressTips ? 0 : 1
                }, a);
            },
            // 下载图片
            downloadTeamAuthImage: function (a) {
                runInvoke(sdkNameToApiName.downloadTeamAuthImage, {
                    serverId: a.serverId,
                    isShowProgressTips: 0 == a.isShowProgressTips ? 0 : 1
                }, a);
            },
            ...
            // 邀请团队成员
            openInviteMember: function (a) {
                a = a || {}, runInvoke('openInviteMember', {}, a);
            },
            // 获取团队认证必要信息（是否是管理员，是否有邀请权限，团队管理员列表，团队总人数）
            getAuthNeededInfo: function (a) {
                a = a || {}, runInvoke('getAuthNeededInfo', {}, a);
            },
            //通知管理员进行团队认证
